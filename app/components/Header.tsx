  ...
  return (
    <nav className="border-b border-[#b0c7cc]/60 bg-white sticky top-0 z-50 shadow-sm shadow-[#74838b]/5">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        <Link href="/" className="flex items-center gap-2 font-extrabold text-xl tracking-tight text-[#455157] group">
          <Image
            src="/logo.svg"
        ...
        <div className="flex items-center gap-6 text-sm font-semibold text-black">
          <a href="/#services" className="hover:text-[#455157] transition-colors duration-200 ease-out cursor-pointer block py-1">Services</a>
