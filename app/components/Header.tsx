...
export default function Header() {
  ...
  return (
    <>
      <div ref={topSentinelRef} className="absolute top-0 left-0 w-full h-px pointer-events-none" />

      <nav className={`sticky top-0 z-50 bg-white transition-all duration-200 ease-in-out ${
        isScrolled 
          ? 'border-b border-[#b0c7cc]/60 shadow-sm shadow-[#74838b]/5' 
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <Link href="/#hero" onClick={closeMenu} className="flex items-center gap-2 font-extrabold text-xl tracking-tight text-[#455157] group">
            <Image
              ...
              height={32}
              priority
              className="w-50 h-full object-contain transition-transform group-hover:scale-102"
            />
          </Link>
